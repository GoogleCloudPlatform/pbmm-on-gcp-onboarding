...
| 3 | [Onboarding Category 3: Gmail Account with forwarding - Domain hosted on Google Domains](#onboarding-category-1-workspace-account---domain-hosted-on-google-domains) |
