...
locals {
  ...
  restricted_network_self_link        = data.terraform_remote_state.network_env.module.base_env.module.restricted_shared_vpc[0].self_link != null ? data.terraform_remote_state.network_env.module.base_env.module.restricted_shared_vpc[0].self_link : ""
