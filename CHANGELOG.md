...
* Create project destination and remove log bucket destination for the centralized logging ([#1148](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1148))
* Groups creation and permissions ([#1110](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1110))
* update terraform-google-modules/network/google to v8.0 ([#1082](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1082))
* Add support for Log Analytics and Remove BigQuery log destination ([#1025](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1025))

### Features

* Add Billing Account Log sinks ([#1164](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1164)) ([a72d12f](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/a72d12f54f4cf637a8261b08e8dd48b98c53a869))
* add instructions for deployment using GitLab pipelines ([#1047](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1047)) ([0805878](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/0805878ff9f5ee5cc2e1fad7a6907a80ba5d28ce))
* add support for fine grained configuration of VPC-flow logs ([#1035](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1035)) ([ee3a1d8](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/ee3a1d819b7a81f8fb8195a57f0bbc4ce23c2809))
* Add support for Log Analytics and Remove BigQuery log destination ([#1025](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1025)) ([25c61c4](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/25c61c48c94eb530776373bffd668a57b0d79ed8))
* Add support to proxy-only subnetworks and new IP CIDR allocation ([#1040](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1040)) ([79b217e](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/79b217ea25ad21a03f07dd4be94dfb736887892e))
* Change old firewall to new network-firewall ([#1041](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1041)) ([f2469c1](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/f2469c1a966220710968bcc1d2be51eb82b33abb))
* Create project destination and remove log bucket destination for the centralized logging ([#1148](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1148)) ([0a03623](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/0a03623744c8d8a5426d929ed60d1aa34e2c3e6c))
* create projects for KMS resources ([#1032](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1032)) ([f16e805](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/f16e80570b0eb026887c0c460ef598fadad23644))
* create subfolders for business units in 4-projects step ([#1039](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1039)) ([06084be](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/06084befe130c23329b014615a2ccf37145dbcfd))
* **deps:** update GO 1.21 ([#1057](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1057)) ([e96ab70](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/e96ab703210acf354348ea3087081625eae16ca4))
* **deps:** Update Terraform google to v5 ([#1059](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1059)) ([87f3832](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/87f3832a5dba424751632c214973e50e75c6af8e))
* **deps:** Update Terraform google to v5 ([#1066](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1066)) ([a6adc7e](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/a6adc7eee3b8b83238122a54a82b35b142c299f2))
* implementing terraform cloud deploy with agents ([#1034](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1034)) ([2c96a2f](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/2c96a2f3f64d608fa6fe4e40fc8807d17305622d))
* make sed and find commands portable between Linux (GNU) and Mac OS (BSD) ([#1043](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1043)) ([62e8c23](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/62e8c236e0e00dbdb2451b6d6708679762657d44))


### Bug Fixes

* Add roles and service enablements to bootstrap project ([#1175](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1175)) ([a759ee9](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/a759ee9ddb429b58b5750523922c07eb83fb152d))
* alternative deployment methods minor issues fix ([#1065](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1065)) ([e09d174](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/e09d1747bc2209b625d765514b4e4d8943c52f13))
* **CI:** bump request_timeout for 1-org ([#1070](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1070)) ([336487b](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/336487bf60b0bc71e21c8ee95fc7cf6a44ae0125))
* **deps:** bump debug from 4.1.1 to 4.3.4 in /1-org/modules/cai-monitoring/function-source ([#1048](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1048)) ([145c433](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/145c4332693d8c0d4da3b8fcead53639574c096f))
* **deps:** update dependency moment to v2.30.1 ([#1068](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1068)) ([05acc75](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/05acc75027a252bdff3335d53cfe5754cff15357))
* **deps:** update GO modules ([#1077](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1077)) ([2d9a438](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/2d9a438a0c77ca8974441e38166d4848329fe031))
* **deps:** Update golangci/golangci-lint-action action to v4 ([#1114](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1114)) ([ba6b860](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/ba6b860c84a3e5cab61e5e559b8d0d2d982c7a64))
* **deps:** Update Terraform terraform-google-modules/bootstrap/google to v7 ([#1093](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1093)) ([16bd67c](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/16bd67ce69cca00d1644d2c127a44b693e849c4a))
* **deps:** update terraform terraform-google-modules/cloud-router/google to v6 ([#1089](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1089)) ([cb5b516](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/cb5b5163c2deef8e54a6ff8df1d0ba923c1a1ed3))
* **deps:** update terraform terraform-google-modules/cloud-storage/google to v5 ([#1088](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1088)) ([5c737b0](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/5c737b04b1e1573daec0c19ffcf95666f09cd9f1))
* **deps:** update terraform terraform-google-modules/kubernetes-engine/google to v29 ([#1094](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1094)) ([0f79a88](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/0f79a88ec4a34b73b58f4132bd3f16e195b8c0f1))
* **deps:** Update Terraform terraform-google-modules/kubernetes-engine/google to v30 ([#1108](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1108)) ([66ea687](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/66ea68735ac3b5ac6fee0da642d9a58fe393e7f5))
* **deps:** update terraform terraform-google-modules/log-export/google to v8 ([#1171](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1171)) ([a63dc88](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/a63dc886fd8a326348fb2b5668f235e562f84e6a))
* **deps:** Update Terraform terraform-google-modules/network/google to v9 ([#1095](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1095)) ([fdba866](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/fdba8669fc6ecb840ce798e63146807974827d5a))
* **deps:** update terraform terraform-google-modules/pubsub/google to v6 ([#1096](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1096)) ([3a92c9a](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/3a92c9ac036f920dbfaf1b7fb9a7ae7ed6bfbd67))
* **deps:** update terraform terraform-google-modules/vm/google to v10 ([#1097](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1097)) ([8a0e477](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/8a0e477325d61cbb8beba528817bd57a00c060b0))
* **deps:** update terraform terraform-google-modules/vpc-service-controls/google to v5 ([#1098](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1098)) ([b1be0d5](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/b1be0d5e362a39d439bc323d7777df8feba5f60c))
* **deps:** Update Terraform terraform-google-modules/vpn/google to v4 ([#1100](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1100)) ([2c4a27b](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/2c4a27b059202878e9190f8b3f8ca1786684771b))
* **deps:** update tf modules ([#1023](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1023)) ([03b1976](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/03b1976b42c427e3efbc879a894641593206d1c6))
* Fix of the new group structure ([#1174](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1174)) ([dd6c09c](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/dd6c09ccc73dc13abf989c511caf73094ecf5d11))
* Fix project labels ([#1107](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1107)) ([eb28ecb](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/eb28ecb1ca659b1279db83b0b7f9667d56698c22))
* Groups creation and permissions ([#1110](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1110)) ([f57a47c](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/f57a47c2e36e9924a3232983385e741fd05ee2f3))
* set the build timeout for the build that creates the Terraform and gcloud image to 20 minutes ([#1071](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1071)) ([7f5ce28](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/7f5ce282154e8e112dedf0f847fec0984fb74652))
* **tfvars:** fix broken symlinks ([#1196](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1196)) ([5e11853](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/5e11853bfced58827cf13f978e23397db6c0418a))
* update terraform-google-modules/network/google to v8.0 ([#1082](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1082)) ([6d8e106](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/6d8e106444ca1b7b04b0beafbde5eac1b353559f))
* update to terraform-google-modules/network/google//modules/network-peering v8 for increased TPG v5 compatibility ([#1073](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/issues/1073)) ([5d808b1](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/commit/5d808b16fe23b0a1d7c6b43664d6d599cfb2bf8b))
