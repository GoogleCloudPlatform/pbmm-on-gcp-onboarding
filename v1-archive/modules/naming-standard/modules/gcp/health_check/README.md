# Overview
This module generates the GC naming convention for the `health_check`.
...
| <a name="output_result_lower"></a> [result\_lower](#output\_result\_lower) | Provides naming convention in lower case to meet GCP requirements |
