# Overview
This module generates the GC naming convention for the `cloud scheduler job`.
...
| location | CSP and Region. Valid values: e = northamericanortheast1 | `string` | n/a | yes |
