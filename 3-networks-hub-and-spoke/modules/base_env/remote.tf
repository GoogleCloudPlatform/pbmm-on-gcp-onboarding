...
locals {
  restricted_project_id             = try(data.terraform_remote_state.org.outputs.shared_vpc_projects[var.env].restricted_shared_vpc_project_id, null)
  restricted_project_number         = try(data.terraform_remote_state.org.outputs.shared_vpc_projects[var.env].restricted_shared_vpc_project_number, null)
