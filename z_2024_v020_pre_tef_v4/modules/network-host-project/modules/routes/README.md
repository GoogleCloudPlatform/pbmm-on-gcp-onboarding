...
| destination\_range | n/a | `string` | n/a | yes |
| module\_depends\_on | List of modules or resources this module depends on. | `list(any)` | `[]` | no |
| network\_name | The name of the network where routes will be created | `any` | n/a | yes |
| next\_hop\_gateway | n/a | `string` | n/a | yes |
| next\_hop\_instance | n/a | `string` | n/a | yes |
| next\_hop\_instance\_zone | n/a | `string` | n/a | yes |
| next\_hop\_ip | n/a | `string` | n/a | yes |
| next\_hop\_vpn\_tunnel | n/a | `string` | n/a | yes |
| priority | n/a | `number` | n/a | yes |
| project\_id | The ID of the project where the routes will be created | `any` | n/a | yes |
| route\_name | n/a | `string` | n/a | yes |
