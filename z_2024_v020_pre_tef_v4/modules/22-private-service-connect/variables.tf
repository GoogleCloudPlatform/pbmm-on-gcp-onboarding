...
# switch to https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_forwarding_rule.html
variable "region" {
...
/*variable "subnetwork_self_link" {
  description = "subNetwork self link for Private Service Connect."
  #type        = string
  type = object({
