...
output "private_service_connect_name" {
  ...
  depends_on = [
    ...
    google_compute_forwarding_rule.forwarding_rule_private_service_connect
  ]
}
...
output "forwarding_rule_name" {
  ...
  value       = google_compute_forwarding_rule.forwarding_rule_private_service_connect.name
...
output "forwarding_rule_target" {
  ...
  value       = google_compute_forwarding_rule.forwarding_rule_private_service_connect.target
