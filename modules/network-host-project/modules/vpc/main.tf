...
locals {
  peer_project       = var.peer_project != "" ? var.peer_project : null
  peer_network       = var.peer_network != "" ? var.peer_network : null
 ...
 *****************************************/
module "peer" {
  count = local.peer_project != null && local.peer_network != null ? 1 : 0
