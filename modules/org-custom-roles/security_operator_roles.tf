...
# Org Policy Admin - Read Only Permissions Only
# Secret Manager Admin - Read Only Permissions Only
# Security Reviewer - View IAM Policies on all resources
# Org role viewer - Read access to all custom roles
# Security Center Admin Viewer - Admin Read Access to Security Center
# Private Logs Viewer - Read only access to stackdriver logs
# Viewer - Read access to all resources.
# Cloud KMS Admin - Administer Cloud KMS resources Read only permissions
# Security Admin - Security Read Only Permissions

# NOTE:  IAM Recommender should be used to filter these down in the future
locals {
  security_operator_roles = {
    security_operators = {
      title       = "Security Operators"
      description = "Security Operators"
      role_id     = "security_operators"
      permissions = [
