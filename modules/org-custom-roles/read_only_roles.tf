...
locals {
  read_only_roles = {
    ...
    # Organization Viewer - See Organization level config - Only the Read only permissions
    # Folder Viewer - See Folder level config - Only the Read only permissions
    # Organization Role Viewer - See Organization level IAM Configs - Only the read only permissions
    # Viewer - Read only access to all resources but not object level viewer
    read_only_users = {
      title       = "Read Only Users"
      description = "Read Only Users"
      role_id     = "read_only_users"
      permissions = [
