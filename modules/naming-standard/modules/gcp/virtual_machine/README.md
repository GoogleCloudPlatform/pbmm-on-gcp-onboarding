# Overview
This module generates the GC naming convention for the `virtual machine`.
...
| <a name="output_result"></a> [result](#output\_result) | Provides naming convention result. |
| <a name="output_result_lower"></a> [result\_lower](#output\_result\_lower) | Provides naming convention result. Lower case to meet GCP requirements |
