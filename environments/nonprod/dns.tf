...
module "private_zone" {
  ...
  labels      = var.labels
  description = "NonProd Private Zone"
...
module "peering_zone" {
  ...
  #private_visibility_config_networks = var.network_self_links
  private_visibility_config_networks = ["projects/${module.net-host-prj.project_id}/global/networks/${module.net-host-prj.network_name[var.nonprod_host_net.networks[0].network_name]}"]

  target_name_server_addresses = [
    {
      ipv4_address    = var.nonprod_dns.nonprod_forward_zone_ipv4_address_1,  #"8.8.8.8",
      forwarding_path = "default"
    },
    {
      ipv4_address    = var.nonprod_dns.nonprod_forward_zone_ipv4_address_2, #"8.8.4.4",
      forwarding_path = "default"
    }
  ]
}
