...
folders = {
  parent = "folders/REPLACE_FOLDER_ID"
...
audit = {                                  # REQUIRED OBJECT. Must include an audit object.
  ...
  billing_account                = "REPLACE_BILLING_ID"      # REQUIRED EDIT. Define the audit billing account
  audit_streams = {
    prod = {
      ...
      bucket_viewer        = "user:admin-super@gcp.obrien.services" # REQUIRED EDIT. 
    }
  }
  audit_lables = {}
}
...
audit_project_iam = [ #REQUIRED EDIT. At least one object is required. The member cannot be the same for multiple objects.
  {
    member = "user:admin-super@gcp.obrien.services"
...
folder_iam = [
  {
    member = "user:admin-super@gcp.obrien.services" # REQUIRED EDIT. 
...
organization_iam = [
  {
    member       = "user:admin-super@gcp.obrien.services"
    organization = "REPLACE_ORGANIZATION_ID" ###########
    roles = [
      "roles/viewer",
    ]
  }
...
guardrails = {
  ...
  billing_account     = "REPLACE_BILLING_ID" # REQUIRED EDIT. Billing Account in the format of ######-######-######
