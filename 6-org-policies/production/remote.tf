...
locals {
  ...
  prj_p_shared_restricted       = try(data.terraform_remote_state.org.outputs.shared_vpc_projects["production"].restricted_shared_vpc_project_id, null)
  prj_p_shared_base             = data.terraform_remote_state.org.outputs.shared_vpc_projects["production"].base_shared_vpc_project_id
  fldr_production               = data.terraform_remote_state.environments.outputs.env_folder
}
